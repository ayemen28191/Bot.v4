...
const translations: Translations = {
  ar: {
    ...
    // ترجمات صفحة السجلات
    logs_monitor_title: 'مراقب السجلات',
    logs_monitor_subtitle: 'مراقبة وتحليل السجلات في الوقت الحقيقي',
    loading_logs: 'جاري تحميل السجلات...',
    connection_status: 'حالة الاتصال',
    connected_live_logs: 'متصل - السجلات المباشرة',
    disconnected_cached_logs: 'غير متصل - السجلات المحفوظة فقط',
    logs_count: 'عرض {filtered} من {total} سجل',
    logs_count_total: 'إجمالي السجلات',
    logs_count_filtered: 'السجلات المرشحة',
    filter_all: 'الكل',
    filter_users: 'المستخدمين',
    filter_system: 'النظام',
    log_level_all: 'جميع المستويات',
    log_level_error: 'أخطاء',
    log_level_warn: 'تحذيرات',
    log_level_info: 'معلومات',
    log_level_debug: 'تتبع',
    search_logs_placeholder: 'بحث في الرسائل والبيانات الإضافية...',
    search_expand_tooltip: 'توسيع البحث',
    logs_actions_menu: 'قائمة الإجراءات',
    refresh_logs: 'تحديث السجلات',
    download_logs_json: 'تنزيل JSON',
    clear_all_logs: 'مسح جميع السجلات',
    clear_logs_confirm: 'هل أنت متأكد من مسح جميع السجلات من الذاكرة؟',
    logs_cleared: 'تم مسح السجلات',
    logs_cleared_desc: 'تم مسح جميع السجلات من الذاكرة',
    logs_refreshed: 'تم تحديث السجلات',
    logs_refreshed_desc: 'تم تحديث السجلات بنجاح',
    logs_downloaded: 'تم التنزيل',
    logs_downloaded_desc: 'تم تنزيل السجلات بنجاح',
    no_logs_match_filters: 'لا توجد سجلات متطابقة مع الفلاتر المحددة',
    log_details_title: 'تفاصيل السجل',
    log_message_label: 'الرسالة:',
    log_metadata_label: 'البيانات الإضافية:',
    log_level_label: 'المستوى:',
    log_source_label: 'المصدر:',
    log_user_label: 'المستخدم:',
    log_time_label: 'الوقت:',
    scroll_to_top_tooltip: 'العودة للأعلى',
    stats_errors: 'أخطاء',
    stats_warnings: 'تحذيرات',
    stats_info: 'معلومات',
    stats_users: 'مستخدمين',
    stats_sources: 'مصادر',
    user_badge: 'مستخدم',
    
    // ترجمات لوحة الإحصائيات المتطورة
    stats_dashboard_title: 'لوحة إحصائيات السجلات',
    stats_overview: 'نظرة عامة على الإحصائيات',
    quick_metrics: 'المقاييس السريعة',
    total_logs: 'إجمالي السجلات',
    total_errors: 'إجمالي الأخطاء',
    total_warnings: 'إجمالي التحذيرات',
    total_info: 'إجمالي المعلومات',
    error_rate: 'معدل الأخطاء',
    warning_rate: 'معدل التحذيرات',
    active_users: 'المستخدمين النشطين',
    active_sources: 'المصادر النشطة',
    logs_over_time: 'السجلات عبر الزمن',
    logs_distribution: 'توزيع السجلات',
    top_sources: 'أكثر المصادر نشاطاً',
    active_users_chart: 'المستخدمين النشطين',
    last_24_hours: 'آخر 24 ساعة',
    last_hour: 'آخر ساعة',
    last_6_hours: 'آخر 6 ساعات',
    last_12_hours: 'آخر 12 ساعة',
    click_to_filter: 'انقر للفلترة',
    logs_count_singular: 'سجل',
    logs_count_plural: 'سجل',
    percentage_of_total: '% من الإجمالي',
    no_data_available: 'لا توجد بيانات متاحة',
    chart_tooltip_count: 'العدد: {count}',
    chart_tooltip_percentage: 'النسبة: {percentage}%',
    stats_updated: 'تم تحديث الإحصائيات',
    stats_loading: 'جاري تحميل الإحصائيات...',
    expand_dashboard: 'توسيع لوحة الإحصائيات',
    collapse_dashboard: 'طي لوحة الإحصائيات',
    dashboard_description: 'مراقبة وتحليل السجلات بصرياً في الوقت الحقيقي',
    
    // Enhanced tabs system translations  
    user_activity_logs: 'سجلات نشاط المستخدمين',
    system_activity_logs: 'سجلات نشاط النظام',
    all_logs_activity: 'جميع السجلات النشطة',
    showing_user_logs_desc: 'عرض السجلات المتعلقة بأنشطة المستخدمين فقط',
    showing_system_logs_desc: 'عرض السجلات المتعلقة بأنشطة النظام فقط',
    showing_all_logs_desc: 'عرض جميع السجلات (المستخدمين والنظام)',
    no_user_logs_found: 'لا توجد سجلات مستخدمين',
    no_system_logs_found: 'لا توجد سجلات نظام',
    no_user_logs_found_desc: 'لا توجد سجلات متطابقة مع الفلاتر المحددة للمستخدمين',
    no_system_logs_found_desc: 'لا توجد سجلات متطابقة مع الفلاتر المحددة للنظام',
    
    // LogCard translations
    copy_success_title: 'تم النسخ',
    copy_success_description: 'تم نسخ النص إلى الحافظة',
    copy_message: 'نسخ الرسالة',
    copy_full_details: 'نسخ التفاصيل الكاملة',
    hide_details: 'إخفاء التفاصيل',
    show_details_card: 'إظهار التفاصيل',
    ...
    login_welcome_subtitle: "قم بتسجيل الدخول للوصول إلى حسابك",
  ...
  hi: {
    ...
    login_welcome_subtitle: 'अपने खाते तक पहुंचने के लिए साइन इन करें',
