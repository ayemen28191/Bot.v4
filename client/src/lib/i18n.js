...
exports.getUserPreferredLanguage = exports.getTextClasses = exports.formatNumber = exports.setUserLanguage = exports.clearLanguageOnLogout = exports.initializeLanguageSystem = exports.changeLanguage = exports.supportedLanguages = exports.getCurrentLanguage = exports.t = exports.setLanguage = void 0;
...
var currentLanguage = 'en'; // English as default language
...
var setLanguage = function (lang, saveToDatabase) {
    ...
    window.dispatchEvent(new CustomEvent('languageChanged', {
        detail: { language: normalizedLang, saveToDatabase: saveToDatabase }
    }));
...
var t = function (key, user) {
    var _a;
    // Get current language with user context
    var lang = (0, exports.getCurrentLanguage)(user);
    // Check if translation exists in cache
    var cacheKey = "".concat(lang, ":").concat(key);
    if (translationCache[cacheKey]) {
        return translationCache[cacheKey];
    }
    // Ensure language is supported, fallback to English
    var validLang = translations[lang] ? lang : 'en';
    // Save translation in cache
    var translation = ((_a = translations[validLang]) === null || _a === void 0 ? void 0 : _a[key]) || key;
...
var getCurrentLanguage = function (user) {
...
var changeLanguage = function (newLanguage, saveToStorage, user) {
    if (saveToStorage === void 0) { saveToStorage = true; }
    if (typeof window !== 'undefined') {
        // Validate language
        var supportedLanguages_1 = ['en', 'ar', 'hi'];
        if (!supportedLanguages_1.includes(newLanguage)) {
        ...
        window.dispatchEvent(new CustomEvent('languageChanged', {
            detail: { language: newLanguage, user: user }
        }));
        return newLanguage;
    }
    return 'en';
...
var initializeLanguageSystem = function (user) {
    if (typeof window !== 'undefined') {
        ...
        var shouldSaveToStorage = user && user.preferredLanguage;
...
var clearLanguageOnLogout = function () {
    if (typeof window !== 'undefined') {
        try {
            ...
            // Reset to English
            (0, exports.changeLanguage)('en', false);
...
exports.clearLanguageOnLogout = clearLanguageOnLogout;
if (typeof window !== 'undefined') {
    // Basic initialization without user context - always start with English
    var lang = 'en'; // Force English as initial language
    document.documentElement.setAttribute('lang', lang);
    ...
    window.addEventListener('languageChanged', function (event) {
        ...
        var newLang = detail.language;
        var isRTL = newLang === 'ar';
        ...
        console.log("Direction changed to: ".concat(isRTL ? 'RTL' : 'LTR', " for language: ").concat(newLang));
    });
}
// Function to set user's preferred language from database
var setUserLanguage = function (userPreferredLang) {
...
var getTextClasses = function (hasNumbers) {
    if (hasNumbers === void 0) { hasNumbers = false; }
    var lang = (0, exports.getCurrentLanguage)();
    var classes = '';
    if (lang === 'ar') {
        classes += 'text-right ';
        if (hasNumbers) {
...
var getUserPreferredLanguage = function (userPreferredLang) {
    // Priority 1: User is logged in and has preferred language in database
